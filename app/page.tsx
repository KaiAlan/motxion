...
const Home = () => {
  return (
    <div className="flex flex-col justify-start my-20 relative">
      ...
      <Paragraph value="Transform Your React Apps with Beautiful, Type-Safe Animated Components - Effortlessly Ready to Use!" className="justify-end"/>
